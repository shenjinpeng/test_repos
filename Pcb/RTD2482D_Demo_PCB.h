...
#if(_PCB_TYPE == _RTD2472D_DEMO_PCB)
...
#if(_MCU_TYPE == _REALTEK_EMBEDDED)
#define _DEBUG_TOOL                          _ISP_FOR_EMBEDDED//   _RS232//_ISP_FOR_EMBEDDED//uart zp0704
#else
...
#if(_PCB_VERSION_C == _ON)
#define _D0_INPUT_PORT_TYPE                    _D0_DVI_PORT //_D0_NO_PORT
#else
...
#define _D0_INPUT_PORT_GROUP                    _INPUT_PORT_GROUP_4
...
#define _INPUT_PORT_SEARCH_POL_0                _D0_INPUT_PORT// _A0_INPUT_PORT// _D0_INPUT_PORT//_A0_INPUT_PORT
...
#define _SOURCE_DVI_SEARCH_TIMES                200
...
//--------------------------------------------------
#define _DCLK_SPREAD_RANGE                      13   //0~15, 0¡÷disable, 15¡÷7.5% FOR EMC 20110825
...
#define _HDCP_KEY_LOCATION                      _HDCP_LOCATION_CODE
...
//--------------------------------------------------
#define _PANEL_ON                             0// 1// 0       // Power on  state for LCD panel
#define _PANEL_OFF                             1// 0//01       // Power off state for LCD panel//2010 12 30 xiaoming request for  paner on circuit
...
#define _HDMI_PN_SWAP                          _ON // _OFF//_ON     // TMDS P/N swap for HDMI input port

#define _DVI_BR_SWAP                           _OFF//_ON// //_ON     // TMDS B/R channel swap for DVI input port
#define _DVI_PN_SWAP                            _OFF//_ON     // TMDS P/N swap for DVI input port
...
// RTD2472D Pin Share
//--------------------------------------------------
#define _PIN_41                                 (0 & 0x03)  // 0 ~ 3 (0: PBD7i, 1: PBD7o<open-drain>, 2: PBD7o<push-pull>,)
#define _PIN_42                                 (0 & 0x03)  // 0 ~ 3 (0: PBD6i, 1: PBD6o<open-drain>, 2: PBD6o<push-pull>,3:IICSCL <open-drain>)
#define _PIN_43                                 (0 & 0x03)  // 0 ~ 3 (0: PBD5i, 1: PBD5o<open-drain>, 2: PBD5o<push-pull>,3:IICSDA <open-drain>)
#define _PIN_44                                 (0 & 0x07)  // 0 ~ 4 (0: PBD4i, 1: PBD4o<open-drain>, 2: PBD4o<push-pull>,3:WS, 4:SPDIF3 )
#define _PIN_45                                 (1 & 0x03)  // 0 ~ 3 (0: PBD3i, 1: PBD3o<open-drain>, 2: PBD3o<push-pull>,3:SCK)
#define _PIN_46                                 (1 & 0x03)  // 0 ~ 3 (0: PBD2i, 1: PBD2o<open-drain>, 2: PBD2o<push-pull>,3:MCK)
#define _PIN_47                                 (0 & 0x03)  // 0 ~ 3 (0: PBD1i, 1: PBD1o<open-drain>, 2: PBD1o<push-pull>,3:SD0)
#define _PIN_48                                 (0 & 0x03)  // 0 ~ 3 (0: PBD0i, 1: PBD0o<open-drain>, 2: PBD0o<push-pull>,3:PWM0)
...
#else
#define _PIN_109                                (1 & 0x07)  // 0 ~ 5 (0: P3D2i, 1: P3D2o<gpo>       , 2: reserved, 3: INT0, 4: TCON[3], 5: SCK)
#endif
...
#else
#define _PIN_121_122_DDC3_ENABLE                (1 & 0x01)  // 0 ~ 1 (0: Enable, 1: Disable) Pin121,122 for DDC3
#define _PIN_121                                (3 & 0x03)  // 0 ~ 3 (0: P7D3i,  1: P7D3o<open-drain>, 2: P7D3o<push-pull>, 3:AUX_CH-N1)
#define _PIN_122                                (3 & 0x03)  // 0 ~ 3 (0: P7D2i,  1: P7D2o<open-drain>, 2: P7D2o<push-pull>, 3:AUX_CH-P1)
#define _PIN_123_124_DDC2_ENABLE                (0 & 0x01)  // 0 ~ 1 (0: Enable, 1: Disable) Pin123,124 for DDC2
#define _PIN_123                                (1 & 0x03)  // 0 ~ 3 (0: P7D1i,  1: P7D1o<open-drain>, 2: P7D1o<push-pull>, 3:AUX_CH-N0)
#define _PIN_124                                (1 & 0x03)  // 0 ~ 3 (0: P7D0i,  1: P7D0o<open-drain>, 2: P7D0o<push-pull>, 3:AUX_CH-P0)
#endif
...
#if(_PCB_VERSION_C == _ON)
#define bD0_CONNECT                             (MCU_PORT63_PIN_REG_FFCA)
sbit bD1_CONNECT                                = P1 ^ 0;

#else
#define bD0_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)
sbit bD1_CONNECT                                = P3 ^ 3;
#endif
...
#else
sbit bHPD_D0                                    = P3 ^ 7;
#define bHPD_D1                                 (MCU_PORT65_PIN_REG_FFCC)
#define D0_HPD_LOW()                            ( bHPD_D0 = 0)
#define D0_HPD_HIGH()                           ( bHPD_D0 = 1)
#define D1_HPD_LOW()                            ( bHPD_D1 &= 0xFE)
#define D1_HPD_HIGH()                           ( bHPD_D1 |= 0x01)
#endif


sbit bLSSCL                                  = P3 ^ 5;//for lightsensor I2C
sbit bLSSDA                                  = P3 ^ 6;//for lightsensor I2C
sbit bLSAdd                                    =P3^7;//for lightsensor ADDRESS select
//--------------------------------------------------
#if(_PCB_VERSION_C == _ON)
#define bPANELPOWER                             (MCU_PORT65_PIN_REG_FFCC)
#else
sbit bPANELPOWER                                = P1 ^ 0;
#endif
...
#define _DISP_RB_SWAP                        _DISABLE// _ENABLE//_DISABLE            // Display Data Port Red/Blue Data Swap
...
#endif  // End of #if(_PCB_TYPE == _RTD2472D_DEMO_PCB)
