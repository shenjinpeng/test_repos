...
/************************************************************/
#define _EXTEND_TABLE_SUPPORT                   _ON
...
#define _PCB_TYPE                               _RTD2545LR_DEMO_PCB
...
#define _CMO_LVDS_19_WXGA                       7      // 1440 x  900
...
#define _PANEL_TYPE                             _AU_LVDS_22_WSXGA
...
#define _OVERSCAN_YPBPR_SUPPORT                 _OFF
...
//---------------------------------------------------------------------------------------------------
//Remind : Check the " CAdjustOdFrcPerformance() " Setting with the following _MEMORY_CONFIG &  _MEMORY_SPEED
//        if the OD or FRC turn on !!
//---------------------------------------------------------------------------------------------------
...
#define _MEMORY_CONFIG                          _1M_16BIT_2PCE
...
#endif //End of #if(_PROJECT == _RTD2545LR_DEMO_BOARD)
