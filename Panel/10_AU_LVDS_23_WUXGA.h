...
#define _PANEL_DH_TOTAL                         2000                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2048                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     2000                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         16                  // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        1200                // Display Vertical Width
#define _PANEL_DV_END                           1216                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         1250                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     2048                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1211                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    1                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   3                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      135                 // Typical Pixel Clock in MHz
