...
#if(_PANEL_TYPE == _AU_LVDS_20_WSXGA)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         1880                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2800                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1840                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         1124                // Display Vertical Total Clock Number in One Display Line
...
#endif  // End of #if(_PANEL_TYPE == _AU_LVDS_20_WSXGA)
