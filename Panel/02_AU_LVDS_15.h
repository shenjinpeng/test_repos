...
#define _PANEL_DH_WIDTH                         1024                // Display Horizontal Width
#define _PANEL_DH_END                           1056                // Display Horizontal End Position

#define _PANEL_DH_TOTAL                         1152                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     1308                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1100                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         12                  // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        768                 // Display Vertical Width
#define _PANEL_DV_END                           780                 // Display Vertical End Position

#define _PANEL_DV_TOTAL                         864                 // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     900                 // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     800                 // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    16                  // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   3                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      80                  // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  100                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  60                  // Mininum Pixel Clock in MHz
...
#endif  // End of #if(_PANEL_TYPE == _AU_LVDS_15)
