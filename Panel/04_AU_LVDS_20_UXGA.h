...
#define _PANEL_DH_WIDTH                         1600                // Display Horizontal Width
#define _PANEL_DH_END                           1632                // Display Horizontal End Position

#define _PANEL_DH_TOTAL                         2160               // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     3200                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1660                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         12                  // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        1200                // Display Vertical Width
#define _PANEL_DV_END                           1212                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         1250                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     2000                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1205                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    1                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   3                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                     162                // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  170                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  120                 // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      50   //T2               // Panel Power On T1 (ms)
...
#define _PANEL_POWER_OFF_T5                     40  //T3                // Panel Power Off T5 (ms)
#define _PANEL_POWER_OFF_T6                     250  //T4               // Panel Power Off T6 (ms)
...
#endif  // End of #if(_PANEL_TYPE == _AU_LVDS_20_UXGA)
