...
#if(_PANEL_TYPE == _CMO_LVDS_20_SXGA_PLUS)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_WIDTH                         1400                // Display Horizontal Width
#define _PANEL_DH_END                           1432                // Display Horizontal End Position

#define _PANEL_DH_TOTAL                         1688                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     1960                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1480                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         12                  // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        1050                // Display Vertical Width
#define _PANEL_DV_END                           1062                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         1066                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1300                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1051                // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  135                 // Maxinum Pixel Clock in MHz
...
#endif  // End of #if(_PANEL_TYPE == _CMO_LVDS_20_SXGA_PLUS)
